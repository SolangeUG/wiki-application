...
# class WikiResourceHandler(handler.TemplateHandler):
#     """
#     WikiResourceHandler inherits from the handler.TemplateHandler class.
#     It aggregates functionalities for retrieving or creating a requested resource by the user.
#     """
#     def render_article(self, editionmode=False, article=None, error=""):
#         self.render("article.html", editionmode=editionmode, article=article, error=error)
#
#     def get(self, title):
#         if title:
...
#
#                     self.render_article(editionmode=True, article=article)
#                 else:
